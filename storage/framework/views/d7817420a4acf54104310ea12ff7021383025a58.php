...
<h3><?php echo app('translator')->get('lang.EmailCompose'); ?></h3>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('breadcrumb-items'); ?>
<li class="breadcrumb-item"><?php echo app('translator')->get('lang.Email'); ?></li>
<li class="breadcrumb-item active"><?php echo app('translator')->get('lang.EmailCompose'); ?></li>
<?php $__env->stopSection(); ?>
                  ...
                  <div class="card-body">
                     <div class="email-app-sidebar">
                        ...
                        <ul class="nav main-menu" role="tablist">
                            <li class="nav-item"><a class="btn-primary btn-block btn-mail" id="pills-darkhome-tab" data-bs-toggle="pill" href="#pills-darkhome" role="tab" aria-controls="pills-darkhome" aria-selected="true"><i class="icofont icofont-envelope me-2"></i> رسالة جديدة</a></li>
                            <li class="nav-item"><a class="show" id="pills-darkprofile-tab" data-bs-toggle="pill" href="#pills-darkprofile" role="tab" aria-controls="pills-darkprofile" aria-selected="false"><span class="title"><i class="icon-import"></i> البريد</span><span class="badge pull-right digits">(236)</span></a></li>
                            <li><a href="#"><span class="title"><i class="icon-folder"></i>جميع الرسائل</span></a></li>
                            <li><a href="#"><span class="title"><i class="icon-new-window"></i>ارسال</span><span class="badge pull-right digits">(69)</span></a></li>
                            <li><a href="#"><span class="title"><i class="icon-pencil-alt"></i> مسودة</span><span class="badge pull-right digits">(59)</span></a></li>
                            <li><a href="#"><span class="title"><i class="icon-trash"></i>السلة</span><span class="badge pull-right digits">(99)</span></a></li>
                            <li><a href="#"><span class="title"><i class="icon-info-alt"></i> هام</span></a></li>
                            <li><a href="#"><span class="title"><i class="icon-star"></i> مميز</span></a></li>
                            <li>
                               <hr>
                            </li>
                            <li><a href="#"><span class="title"><i class="icon-email"></i> لم يقراء</span></a></li>
                            <li><a href="#"><span class="title"><i class="icon-export"></i> رسائل  مزعجة</span></a></li>
                            <li><a href="#"><span class="title"><i class="icon-share"></i> صندوق الصادر</span></a></li>
                            <li><a href="#"><span class="title"><i class="icon-file"></i> تعديل</span></a></li>
                            <li><a href="#"><span class="title"><i class="icon-bell"></i> تنبية</span></a></li>
                            <li><a href="#"><span class="title"><i class="icon-notepad"></i> ملاحظات</span><span class="badge pull-right digits">(20)</span></a></li>
                         </ul>
                     </div>
                  </div>
               </div>
                     ...
                     <div class="email-top">
                        <div class="row">
                           ...
                           <div class="col text-end">
                              <div class="dropdown">
                                 <button class="btn bg-transparent dropdown-toggle p-0 text-muted" id="dropdownMenuButton" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">المزيد</button>
                              ...
                              <div class="email-wrapper">
                                 <form class="theme-form">
                                    ...
                                    <select class="form-select mb-3" >
                                        <option selected>عملاء خدمة </option>
                                        <option value="1">مقيم</option>
                                        <option value="2">تمم</option>
                                        <option value="3">شموس</option>
                                        <option value="3">كل الخدمات</option>

                                      </select>
                                      <select class="form-select mb-3" >
                                        <option selected>حالة الاشتراك</option>
                                        <option value="1">نشط</option>
                                        <option value="2">منهي</option>
                                      </select>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Cuba\resources\views/taqnnen/email/email-compose.blade.php ENDPATH**/ ?>