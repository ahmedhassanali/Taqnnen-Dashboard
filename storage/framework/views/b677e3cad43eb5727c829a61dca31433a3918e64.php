                                    ...
                                    <div class="row">
                                        <div class="col-md-3 border-right">
                                            <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" width="150px" src="https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg"><span class="font-weight-bold">حمدان على عيد</span><span class="text-black-50">Hamohamed@gmail.com</span><span>
                                                <a class="btn btn-primary"  href="<?php echo e(route('customer-notes')); ?>">ملاحظات</a>
                                            </span></div>
                                        </div>
                                        ...
                                        <div class="col-md-4 ">
                                         ...
                                         <div class=" col-md-12">
                                                ...
                                                <div class="card  " style="width: 18rem;">
                                                    <img src="<?php echo e(asset('assets/images/opportunities/muqemm.jpg')); ?>" class="card-img-top" alt="...">
                                                    <div class="card-body">
                                                ...
                                                <div class="card " style="width: 18rem;">
                                                    <img src="<?php echo e(asset('assets/images/opportunities/tamm.jpg')); ?>" class="card-img-top" alt="...">
                                                    <div class="card-body">
                                                ...
                                                <div class="card " style="width: 18rem;">
                                                    <img src="<?php echo e(asset('assets/images/opportunities/shmos.jpg')); ?>" class="card-img-top" alt="...">
                                                    <div class="card-body">
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Cuba\resources\views/taqnnen/customers/profile.blade.php ENDPATH**/ ?>