                                              ...
                                              <div>
                                                ...
                                                <div class="attachment">
                                                   <ul class="list-inline">
                                                      <li class="list-inline-item" style="width: 120px"><img class="img-fluid" src="<?php echo e(asset('assets/images/email/1.jpg')); ?>" alt=""></li>
                                                      <li class="list-inline-item"style="width: 120px"><img class="img-fluid" src="<?php echo e(asset('assets/images/email/2.jpg')); ?>" alt=""></li>
                                                      <li class="list-inline-item"style="width: 120px"><img class="img-fluid" src="<?php echo e(asset('assets/images/email/3.jpg')); ?>" alt=""></li>
                                                   </ul>
                                                </div>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Cuba\resources\views/taqnnen/subscription/add.blade.php ENDPATH**/ ?>