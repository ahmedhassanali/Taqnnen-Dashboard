...
Route::prefix('dashboard')->group(function () {
    ...
    Route::view('Marketingdashboard', 'dashboard.marketing_dashboard')->name('Marketingdashboard');
});
///////////////////////////////// chat route///////////////////////////////
Route::prefix('chat')->group(function () {
    Route::view('chat', 'apps.chat')->name('chat');
    Route::view('chat-link', 'taqnnen.chat.chatlink')->name('chat-link');
});

///////////////////////////////// Opportunities route///////////////////////////////
Route::prefix('Opportunities')->group(function () {
    Route::view('add', 'taqnnen.Opportunities.add')->name('addOpportunities');
    Route::view('view', 'taqnnen.Opportunities.view')->name('viewOpportunities');
});

///////////////////////////////// services route///////////////////////////////
Route::prefix('services')->group(function () {
    Route::view('add', 'taqnnen.services.add')->name('addservices');
    Route::view('view', 'taqnnen.services.view')->name('viewservices');
});


///////////////////////////////// users route///////////////////////////////
Route::prefix('users')->group(function () {
    Route::view('add', 'taqnnen.users.add')->name('addusers');
    Route::view('view', 'taqnnen.users.view')->name('viewusers');
});


///////////////////////////////// customers route///////////////////////////////
Route::prefix('customers')->group(function () {
    Route::view('add', 'taqnnen.customers.add')->name('addcustomers');
    Route::view('view', 'taqnnen.customers.view')->name('viewcustomers');
});
...
Route::prefix('subscription')->group(function () {
    Route::view('add', 'taqnnen.subscription.add')->name('addsubscription');
    Route::view('view', 'taqnnen.subscription.view')->name('viewsubscription');
});
...
Route::prefix('report')->group(function () {
    ...
    Route::view('main', 'taqnnen.report.main')->name('mainreport');
    Route::view('average', 'taqnnen.report.Average')->name('averagereport');
    Route::view('bill', 'taqnnen.report.bill')->name('billreport');
    Route::view('financial', 'taqnnen.report.financial')->name('financialreport');

});

///////////////////////////////// support route///////////////////////////////
Route::view('support-ticket', 'apps.support-ticket')->name('support-ticket');
Route::view('supportdashboard', 'dashboard.marketing_dashboard')->name('supportdashboard');

///////////////////////////////// permissions route///////////////////////////////
Route::view('landing-page', 'pages.landing-page')->name('landing-page');

///////////////////////////////// permissions route///////////////////////////////
Route::view('permissions', 'taqnnen.permissions.view')->name('permissions');
Route::view('addrole', 'taqnnen.permissions.add')->name('addrole');


///////////////////////////////// network route///////////////////////////////
Route::view('network', 'taqnnen.network.network')->name('network');

///////////////////////////////// customers profile route//////////////////////
Route::view('customer-profile', 'taqnnen.customers.profile')->name('customer-profile');

///////////////////////////////// customers notes route////////////////////////
Route::view('customer-notes', 'taqnnen.customers.notes')->name('customer-notes');

///////////////////////////////// settings route///////////////////////////////
Route::view('settings', 'taqnnen.settings.settings')->name('settings');

///////////////////////////////// invoice route ///////////////////////////////
Route::view('invoice', 'taqnnen.subscription.invoice')->name('invoice');

///////////////////////////////// marketing route///////////////////////////////
Route::prefix('marketing')->group(function () {
    Route::view('sms', 'taqnnen.marketing.sms')->name('marketingsms');
    Route::view('watsapp', 'taqnnen.marketing.watsapp')->name('marketingwatsapp');
});

///////////////////////////////// email route///////////////////////////////
Route::prefix('email')->group(function () {
    Route::view('email-application', 'taqnnen.email.email-application')->name('email-application');
    Route::view('email-compose', 'taqnnen.email.email-compose')->name('email-compose');
});
